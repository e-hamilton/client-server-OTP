...
/*
**	"otp_dec.c"
** 	Usage:	otp_dec [encrypted text file] [key file] [otp_dec_d's port]
**	Sends contents of encrypted text file and key file to otp_dec_d
** 	(daemon), which returns a decrypted message. otp_dec then prints
...
int main(int argc, char *argv[])
{
	...
	textContents = readFromFile(textfile, 'D');	// Message code 'D' = decrypt
